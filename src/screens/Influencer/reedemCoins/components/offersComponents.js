    ...
    return (
        <CardComponent cardStyle={{ width: 120, height: 168, backgroundColor: theme.lightPurple, borderRadius: 10, alignItems: 'center' }}>
            <View style={{ alignItems: 'center' }}>
                ...
                <Text style={{ lineHeight: 18, fontFamily: theme.Poppins.regular,fontSize: 12, textAlign: 'center', marginTop: 6 }}>10% off on MODAVASTRA</Text>
                ...
                <Chip title={'100 coins'}
                        ...
                        textStyle={{ fontFamily: theme.Poppins.regular,fontSize: 12, lineHeight: 18,color:theme.TextBlack }}
                    />
            </View>
        </CardComponent>
    )
