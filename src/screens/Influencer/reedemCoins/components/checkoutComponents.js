...
function CheckOutComponents() {
    return (
        <CardComponent  cardStyle={{ width: 328, height: 98, backgroundColor: '#f9f9f9', borderRadius: 10, flexDirection: 'row', overflow:'hidden',shadowColor: '#171717',shadowOffset: {width: -2, height: 4},shadowOpacity: 0.8,shadowRadius: 50,
    }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, justifyContent: 'space-around', }}>
                ...
                <View >
                    ...
                    <View style={{ marginTop: 9, width: 80, height: 20, borderRadius: 10, backgroundColor: theme.Purple, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ fontSize: 12, fontWeight: '400', lineHeight: 18, color: theme.White }}>100 coins</Text>
                    </View>
                </View>
                <BackIcon />
            </View>
