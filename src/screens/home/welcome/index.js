            ...
            <ScrollView 
                ...
                <View style={{ marginTop: '8%', marginHorizontal: '4%', flex:1, alignItems: 'center'}}>
                    ...
                    <View style={{padding: '2%'}}>
                        <FastImage style={{height: 46, width: 119}} source={require('../../../assets/images/logo2.png')}/>
                    </View>
                    <View style={{flexWrap: 'wrap', alignItems: 'center', width: '70%',}}>
                    ...
                    <ScrollView
                        ...
                        showsVerticalScrollIndicator={false}
                        >
                            <View style={{flex:1, marginTop: '0%', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', flexWrap: 'wrap',}}>
                                {user}
                            </View>
                    </ScrollView>
                </View>
